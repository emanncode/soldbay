...
const textareaClass =
  "min-h-32 w-full rounded-xl border-none bg-background px-4 py-3 shadow-none focus-visible:border-ring/60"
        ...
        {sent ? (
          ...
          >
            <motion.div
              ...
              className="mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-primary shadow-elevation-3"
            >
              <motion.svg
                width="32"
                height="32"
            ...
            <motion.p
              ...
              className="mt-4 max-w-md text-base text-primary/60"
            >
            ...
            >
              <Button
                ...
                variant="outline"
                size="lg"
                className="rounded-full border-foreground/60 font-semibold text-foreground hover:bg-muted"
                onClick={() => {
                  setSent(false)
                  setError(null)
                }}
          ...
          >
            <CardHeader className="px-8 py-4 md:px-12 md:pt-12">
