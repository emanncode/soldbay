...
export const MOCK_LISTINGS: PublicListing[] = [
  {
    ...
    description:
      "Premium brown leather crossbody bag. Excellent condition, genuine brass buckles, perfect for campus lectures and everyday essentials.",
    price: "15000",
    images: [
      "https://images.unsplash.com/photo-1760624089496-01ae68a92d58?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3ODkxODYxOTZ8&ixlib=rb-4.1.0&q=80&w=1080",
    ],
    stock: 1,
    status: "AVAILABLE",
  ...
  },
  {
    ...
    description:
      "Noise-cancelling wireless earbuds with deep bass and 24-hour battery case. Used for only 3 weeks during revision.",
    price: "5500",
    images: [
      "https://images.unsplash.com/photo-1648447269929-38b2cb32ebcd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3ODkxODYxOTd8&ixlib=rb-4.1.0&q=80&w=1080",
    ],
    stock: 3,
    status: "AVAILABLE",
  ...
  },
  {
    ...
    title: "Vintage Leather Crossbody Bag",
    description:
      "Sold vintage leather crossbody bag, authentic leather with brass hardware.",
    price: "15000",
    images: [
      "https://images.unsplash.com/photo-1758542988969-39a10168b2ce?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3ODkxODYxOTh8&ixlib=rb-4.1.0&q=80&w=1080",
    ],
    stock: 0,
    status: "SOLD",
  ...
  },
  {
    ...
    sellerId: "seller-4",
    categoryId: "cat-4",
    title: "Dorm Study Lamp — Like New",
    description:
      "3-level touch brightness desk lamp with built-in rechargeable battery. Lasts through hostel power outages.",
    price: "3500",
    images: [],
    stock: 1,
    status: "AVAILABLE",
  ...
  },
  {
    ...
    description:
      "Original Casio fx-991EX ClassWiz calculator. Natural textbook display, approved for university matric exams.",
    price: "12000",
    images: [
  ...
  },
  {
    ...
    description:
      "Fast-boiling stainless steel kettle with automatic shut-off. Perfect for quick noodles and morning coffee in the hostel.",
    price: "6000",
    images: [
  ...
  },
  {
    ...
    description:
      "Classic blue denim jacket, oversized unisex fit, sturdy cotton denim with silver buttons.",
    price: "8500",
    images: [
  ...
  },
  {
    ...
    description:
      "CHM 101/102 course textbook. Includes end-of-chapter worked problems and summary notes.",
    price: "3000",
    images: [
  ...
  },
  {
    ...
    description:
      "USB powered cooling stand with quiet dual blue LED fans. Fits laptops up to 15.6 inches.",
    price: "7200",
    images: [
  ...
  },
  {
    ...
    description:
      "Single student mattress foam in clean fabric cover with companion orthopedic pillow. Barely used 1 semester.",
    price: "18000",
    images: [
  ...
  },
  {
    ...
    description:
      "Crisp white low-top canvas sneakers, rubber sole, comfortable for walking across campus faculty buildings.",
    price: "7000",
    images: [
  ...
  },
  {
    ...
    description:
      "Comprehensive biology textbook for BIO 101/201 students. Full-color diagrams and glossary.",
    price: "6500",
    images: [
...
export async function getMockListingById(id: string): Promise<ListingDetail> {
  await delay(150);
  const found =
    MOCK_LISTINGS.find((item) => item.id === id) || MOCK_LISTINGS[0];
